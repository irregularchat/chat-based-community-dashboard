        ...
        <Card className="w-full max-w-2xl">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Community Platform Integration Disabled
            </CardTitle>
            <CardDescription>
              Community platform integration is not currently active. Please contact your administrator to enable Matrix and Signal functionality.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Manage Matrix and Signal messaging, groups, and user interactions across platforms
              </p>
            </div>
